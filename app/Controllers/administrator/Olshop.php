...
class Olshop extends BaseController
{
    ...
    public function printAll(){
        ...
        $this->PageData->title = "Olshop Data";
        $this->PageData->subtitle = ["Olshop", "Print All"];
        $this->PageData->url = "administrator/Olshop/printAll/";
        ...
        return view('administrator/olshop/olshop_print', $data);
    }
