...
class Superadmin extends BaseController
{
    ...
    {
        $this->model = new Superadmin_model(); //Set Default Models Of this Controller
    ...
    protected function onLoad(){
        $this->getLocale();
        $this->PageData->parent = "superadministrator/Superadmin";
        $this->PageData->header = (session()->has("level") ? NULL : ucfirst(str_replace("_", '', session("level"))) . " :: ") . 'Superadmin';
    ...
    public function index()
    {
        ...
        $this->PageData->title = "superadministrator/Superadmin";
        $this->PageData->subtitle = [
            $this->PageData->title => 'superadministrator/Superadmin/index'
        ];
        $this->PageData->url = "superadministrator/Superadmin/index";
        ...
        return view('superadministrator/superadmin/superadmin_list', $data);
        //endindex
    }
    ...
    public function read($id=NULL)
    {
        ...
        $this->PageData->title = "Superadmin Detail";
        $this->PageData->subtitle = [
            'Superadmin' => 'superadministrator/Superadmin/index',
            'Detail' => 'superadministrator/Superadmin/read/' . urlencode(base64_encode($id)),
        ];
        $this->PageData->url = "superadministrator/Superadmin/read/" . urlencode(base64_encode($id));
        ...
        return view('superadministrator/superadmin/superadmin_read', $data);
    }
    ...
    public function create()
    {
        ...
        $this->PageData->title = "Create Superadmin";
        $this->PageData->subtitle = [
            'Superadmin' => 'superadministrator/Superadmin/index',
            'Create New Item' => 'superadministrator/Superadmin/create',
        ];
        $this->PageData->url = "superadministrator/Superadmin/create";
        ...
        return view('superadministrator/superadmin/superadmin_form', $data);
    }
    ...
    public function update($id=NULL)
    {
        ...
        $this->PageData->title = "Update Superadmin";
        $this->PageData->subtitle = [
            'Superadmin' => 'superadministrator/Superadmin/index',
            'Update Item' => 'superadministrator/Superadmin/update/' . urlencode(base64_encode($id)),
        ];
        $this->PageData->url = "superadministrator/Superadmin/update/" . urlencode(base64_encode($id));
    ...
    public function printAll(){
        ...
        $this->PageData->title = "Superadmin Data";
        $this->PageData->subtitle = ["Superadmin", "Print All"];
        $this->PageData->url = "superadministrator/Superadmin/printAll/";
        ...
        return view('superadministrator/superadmin/superadmin_print', $data);
    }
