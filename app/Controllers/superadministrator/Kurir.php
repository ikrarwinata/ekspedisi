...
class Kurir extends BaseController
{
    ...
    {
        $this->model = new Kurir_model(); //Set Default Models Of this Controller
    ...
    protected function onLoad(){
        $this->getLocale();
        $this->PageData->parent = "superadministrator/Kurir";
    ...
    public function index()
    {
        ...
        $this->PageData->title = "superadministrator/Kurir";
        $this->PageData->subtitle = [
            $this->PageData->title => 'superadministrator/Kurir/index'
        ];
        $this->PageData->url = "superadministrator/Kurir/index";
        ...
        return view('superadministrator/kurir/kurir_list', $data);
        //endindex
    }
    ...
    public function read($id=NULL)
    {
        ...
        $this->PageData->title = "Kurir Detail";
        $this->PageData->subtitle = [
            'Kurir' => 'superadministrator/Kurir/index',
            'Detail' => 'superadministrator/Kurir/read/' . urlencode(base64_encode($id)),
        ];
        $this->PageData->url = "superadministrator/Kurir/read/" . urlencode(base64_encode($id));
        ...
        return view('superadministrator/kurir/kurir_read', $data);
    }
    ...
    public function create()
    {
        ...
        $this->PageData->title = "Create Kurir";
        $this->PageData->subtitle = [
            'Kurir' => 'superadministrator/Kurir/index',
            'Create New Item' => 'superadministrator/Kurir/create',
        ];
        $this->PageData->url = "superadministrator/Kurir/create";
        ...
        return view('superadministrator/kurir/kurir_form', $data);
    }
    ...
    public function update($id=NULL)
    {
        ...
        $this->PageData->title = "Update Kurir";
        $this->PageData->subtitle = [
            'Kurir' => 'superadministrator/Kurir/index',
            'Update Item' => 'superadministrator/Kurir/update/' . urlencode(base64_encode($id)),
        ];
        $this->PageData->url = "superadministrator/Kurir/update/" . urlencode(base64_encode($id));
    ...
    public function printAll(){
        ...
        $this->PageData->title = "Kurir Data";
        $this->PageData->subtitle = ["Kurir", "Print All"];
        $this->PageData->url = "superadministrator/Kurir/printAll/";
        ...
        return view('superadministrator/kurir/kurir_print', $data);
    }
